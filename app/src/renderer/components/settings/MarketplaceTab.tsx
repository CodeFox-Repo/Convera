...
export function MarketplaceTab({
  ...
  return (
    <Card className="bg-card text-foreground dark:bg-background/90 border-none shadow-sm">
      <CardHeader>
                    ...
                    <div className="flex flex-col space-y-2">
                      {availableServers.map((server) => {
                        ...
                        return (
                          <div
                            key={server.id}
                            className="bg-secondary hover:bg-secondary/80 dark:bg-background/60 dark:hover:bg-background/90 flex items-center justify-between rounded-md p-4 transition-colors dark:border dark:border-gray-700"
                          >
                            ...
                            <div className="flex justify-end">
                              <Button
                                ...
                                className={
                                  isInstalled
                                    ? "text-muted-foreground ml-4 cursor-not-allowed dark:border-gray-600"
                                    : "bg-primary hover:bg-primary/90 ml-4 text-white/90 dark:text-white/90"
                                }
                                onClick={() =>
                                  !isInstalled &&
                                ...
                                disabled={
                                  installingTools[server.id] || isInstalled
                                }
                              >
                        ...
                        return (
                          ...
                          >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                !isInstalled && handleOpenCommunityDialog(item)
                              }
                              disabled={
                                installingTools[item.mcpId] || isInstalled
                              }
                            >
...
// }`}
      ...
      >
        <DialogContent className="dark:bg-background/95 sm:max-w-[600px] dark:border-gray-700">
          <DialogHeader>
            <DialogTitle>
              Add MCP Server - {selectedCommunityItem?.name}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <p className="text-muted-foreground text-sm">
            ...
            {selectedCommunityItem && (
              <div className="bg-secondary/20 dark:bg-background/70 flex flex-col space-y-2 rounded-md p-3 dark:border dark:border-gray-700">
                <p className="text-sm font-medium">
                  {selectedCommunityItem.description}
                </p>
                {selectedCommunityItem.githubUrl && (
                  <a
                    ...
                    className="text-primary flex items-center text-sm hover:underline dark:text-blue-400"
                  >
            ...
            <div className="relative">
              <textarea
                ...
                className="bg-secondary/50 dark:bg-background/60 h-[250px] w-full rounded-md border p-4 font-mono text-xs dark:border-gray-700"
                placeholder={`// Example:
// {
//   "mcpServers": {
//     "example-server": {
...
// }`}
          ...
          <DialogFooter className="mt-4">
            ...
            <Button
              ...
              disabled={!communityConfig.trim() || isSubmitting}
            >
              {isSubmitting ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
