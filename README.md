...
- Press `Control+Shift+Enter` to activate Foxyfox from anywhere on your system
- If Foxyfox is already visible and focused, pressing `Control+Shift+Enter` will hide it
