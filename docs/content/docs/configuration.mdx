---
title: Configuration
description: Customize FoxyChat to suit your needs
icon: SettingsIcon
---
...
|----------|-------------|
| `FOXYCHAT_OPENAI_API_KEY` | OpenAI API key |
| `FoxyCHAT_OPENROUTER_API_KEY` | OpenRouter API key |
| `FoxyCHAT_PROXY_HOST` | Proxy host |
| `FoxyCHAT_PROXY_PORT` | Proxy port |
| `FoxyCHAT_DEBUG` | Enable debug mode (set to "true") |
