...
export const ChatProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  // Memoized so a provider render that changed nothing consumers read does
  // not re-render every useChatContext() component — with a fresh object each
  // time, one keystroke re-rendered the entire message list.
